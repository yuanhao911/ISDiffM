...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.dec_input_emb = nn.Conv1d(in_channels=length_signal,out_channels = nyquist_size, kernel_size = 1)
    ...
    def forward(self, dec_inputs, enc_inputs, enc_outputs):                               # dec_inputs: [batch_size, tgt_len]
        ...
        dec_inputs = self.dec_input_emb(enc_outputs) # enc_outputs 128 180 128
        dec_inputs = self.dec_input_fc(dec_inputs)
