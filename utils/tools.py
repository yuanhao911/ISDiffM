...
batch_size = 1024
nyquist_size = 51
nyquist_size_one_stage = 8
nyquist_seq = nyquist_size + 1
feature_size = 9
nyquist_feature_size = 2
nyquist_feature_size_one_stage = 1
epoch = 1000
# simple_interval = 1 # 10-dataset1;1-dataset3;1-dataset4
num_timesteps = 1000
num_proposals = 51 # 51-dataset1 dataset2 dataset3; 38-dataset4
